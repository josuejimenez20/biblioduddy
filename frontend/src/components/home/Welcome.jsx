    ...
    >
      <Box sx={home.container}>
        ...
        <Typography variant="h6" sx={home.description}>
          Únete a los usuarios que usan BiblioBuddy y olvidaron por completo los tiempos en los que su lectura era difícil de seguir. Hogar para aquellos usuarios que quieren que leer sea más simple, el inicio de una nueva era para lectores novatos e incluso un aire refrescante para aquellos veteranos.
        </Typography>
