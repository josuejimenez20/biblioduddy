...
} from "../../slices/wishBooks/editBookSlice";

export const editWishBook = (bookData) => async (dispatch) => {

    try {
        dispatch(fetchEditBook());
        const { data, status } = await axios.post(`http://localhost:3000/api/v1/wish/edit`, bookData);
